...
var ImageEditorWrapper = /*#__PURE__*/function (_Component) {
  ...
  function ImageEditorWrapper(_ref) {
    ...
    _defineProperty(_assertThisInitialized(_this), "processConfig", function (config) {
      var tools = config.tools || _config2.TOOLS;
    ...
    _this.state = {
      ...
      t: _objectSpread({}, _i18n.default[_config.language], {}, _config.translations[_config.language]),
      ...
      theme: {
        ...
        fonts: _objectSpread({}, (_config.colorScheme === 'light' ? _light.default : _dark.default).fonts, {}, _config.theme.fonts)
      }
    };
    return _this;
  }
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ImageEditorWrapper, "ImageEditorWrapper", "/Users/simon/open-source/filerobot-image-editor/projects/react/ImageEditorWrapper.js");

  __REACT_HOT_LOADER__.register(_default, "default", "/Users/simon/open-source/filerobot-image-editor/projects/react/ImageEditorWrapper.js");
}();
