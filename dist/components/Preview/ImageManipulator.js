...
var ImageManipulator = /*#__PURE__*/function (_Component) {
  ...
  function ImageManipulator() {
    ...
    _defineProperty(_assertThisInitialized(_this), "generateCloudimageURL", function (operations, original) {
      ...
      var baseURL = filerobotURL ? filerobot.doNotPrefixURL ? '' : filerobotURL : cloudimage.doNotPrefixURL ? '' : cloudUrl;
      ...
      var isProcessImage = cropOperation || resizeOperation || orientationOperation || watermarkOperation;
      var cropQuery = '';
      var resizeQuery = '';
      ...
      if (watermarkOperation) {
        watermarkQuery = (cropQuery || resizeQuery || orientationOperation ? '&' : '') + _this.getWatermarkArguments(watermark);
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "initWatermark", function () {
      ...
      if (!watermark.applyByDefault) {
        updateState({
          watermark: _objectSpread({}, watermark, {
            applyByDefault: true
          })
        });
      }
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(INITIAL_PARAMS, "INITIAL_PARAMS", "/Users/simon/open-source/filerobot-image-editor/projects/react/components/Preview/ImageManipulator.js");

  __REACT_HOT_LOADER__.register(ImageManipulator, "ImageManipulator", "/Users/simon/open-source/filerobot-image-editor/projects/react/components/Preview/ImageManipulator.js");
}();
