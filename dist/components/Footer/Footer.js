...
var _default = (_temp = /*#__PURE__*/function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_styledComponents.Footer, null, _react.default.createElement(_styledComponents.ResetBtn, {
        muted: activeBody !== 'preview',
        onClick: function onClick() {
          activeBody === 'preview' && resetOperations();
        },
        title: t['footer.reset']
      }), _react.default.createElement(_styledComponents.PreviousBtn, {
        onClick: function onClick() {
          !isPrevForbidden && redoOperation(currentOperationIndex - 1);
        },
        muted: isPrevForbidden,
        title: t['footer.undo']
      }), _react.default.createElement(_styledComponents.NextBtn, {
        onClick: function onClick() {
          !isNextForbidden && redoOperation(currentOperationIndex + 1);
        },
        muted: isNextForbidden,
        title: t['footer.redo']
      }), logoImage && watermark && _react.default.createElement(_styledComponents.Switcher, {
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, "default", "/Users/simon/open-source/filerobot-image-editor/projects/react/components/Footer/Footer.js");
}();
