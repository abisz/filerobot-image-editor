...
var _default = (_temp = /*#__PURE__*/function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_this), "loadImage", function () {
      ...
      img.onload = function () {
        ...
        if (mode === 'manual' && (widthLimit < img.width || heightLimit < img.height)) {
          ...
          _this.setState(_objectSpread({}, propsOnApply, {
            activeBody: 'preview',
            isPreResize: false
          }), function () {
            _this.setState({
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      var previewProps = _objectSpread({
        t: t,
        theme: theme,
        cropDetails: cropDetails,
        original: original,
      ...
      return _react.default.createElement(_index.Wrapper, null, _react.default.createElement(_index2.Header, headerProps), _react.default.createElement(_index.PreviewWrapper, null, activeBody === 'preview' && _react.default.createElement(_index2.Preview, previewProps), activeBody === 'preResize' && _react.default.createElement(_index2.PreResize, previewProps), _react.default.createElement(_index.Spinner, {
        overlay: true,
        show: isShowSpinner,
        label: t['spinner.label']
      })), _react.default.createElement(_index2.Footer, footerProps));
    }
  }]);
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(INITIAL_PARAMS, "INITIAL_PARAMS", "/Users/simon/open-source/filerobot-image-editor/projects/react/ImageEditor.js");

  __REACT_HOT_LOADER__.register(_default, "default", "/Users/simon/open-source/filerobot-image-editor/projects/react/ImageEditor.js");
}();
